      ...
      <div className="relative min-h-screen">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-6 pt-20 pb-20 lg:px-8">
          ...
          >
            ...
            >
              <Sparkles style={{ color: accentColor }} className="h-6 w-6" />
            </div>
            <h1 className="font-display text-4xl font-bold tracking-tight text-foreground">
              Creator District System
            </h1>
            <p className="mx-auto mt-4 max-w-2xl text-base text-muted-foreground">
              AI-powered content execution infrastructure.

            </p>
            {/* Animated Divider */}
            <div className="mx-auto mt-6 h-[2px] w-24 rounded-full bg-gradient-to-r from-transparent via-purple-400/80 to-transparent" />

            <div className="relative mx-auto mt-2 h-[8px] w-40 overflow-hidden rounded-full">
              <div className="absolute inset-0 animate-shimmer bg-gradient-to-r from-transparent via-purple-500/30 to-transparent" />
            </div>
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <p className="text-sm leading-relaxed text-muted-foreground">
                Creator District is your creative command center. Every tool is engineered to accelerate your creative process—from ideation to final execution. The Hook Engine generates viral content frameworks, while the Content Blueprint Builder orchestrates your entire content strategy.
              </p>
            </motion.div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="font-semibold text-foreground uppercase tracking-widest text-xs" style={{ color: accentColor }}>
                    LAYER 01: CREATOR ACTIVATION
                  </p>
                  <p className="mt-2 text-sm text-muted-foreground">
                    The Creator layer is entering controlled activation, deploying structured content intelligence across the district.
                    Layer 01 establishes the Hook Engine and foundational execution systems.
                  </p>
                </div>
              </div>
            </motion.div>
