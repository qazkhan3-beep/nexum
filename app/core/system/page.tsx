...
import { Network, ArrowLeft, Lock } from 'lucide-react'
      ...
      <div className="relative min-h-screen">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-6 pt-20 pb-20 lg:px-8">
          ...
          >
            ...
            >
              <Network style={{ color: accentColor }} className="h-6 w-6" />
            </div>
            <h1 className="font-display text-4xl font-bold tracking-tight text-foreground">
              Core System Overview
            </h1>
            <p className="mx-auto mt-4 max-w-2xl text-base text-muted-foreground">
              Command & orchestration layer of NEXUM.


            </p>
            {/* Animated Divider */}
            <div className="mx-auto mt-6 h-[2px] w-24 rounded-full bg-gradient-to-r from-transparent via-cyan-400/80 to-transparent" />

            <div className="relative mx-auto mt-2 h-[8px] w-40 overflow-hidden rounded-full">
              <div className="absolute inset-0 animate-shimmer bg-gradient-to-r from-transparent via-cyan-500/30 to-transparent" />
            </div>
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <p className="text-sm leading-relaxed text-muted-foreground">
                Core is the foundational layer of NEXUM. It integrates your AI intelligence, workflow orchestration, and system health monitoring into one unified command center. Every action across Creator District, Capital Lab, and The Arena flows through Core's intelligence engine.
              </p>
            </motion.div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="font-semibold text-foreground uppercase tracking-widest text-xs" style={{ color: accentColor }}>
                    LAYER 01: ACTIVATION IN PROGRESS
                  </p>
                  <p className="mt-2 text-sm text-muted-foreground">
                    The Core layer is being activated in controlled stages to ensure system integrity and intelligent scaling.
                    Layer 01 is now live, initializing foundational infrastructure and orchestration protocols.
